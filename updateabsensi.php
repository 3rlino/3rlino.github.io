...
if(!empty($_POST))
{
 $output = '';
    ...
    $query = "
    update absen set latitude = '$latitude', longitude = '$longitude', user ='$user', jenis_absen = '$jenis_absen', keterangan = '$keterangan', foto_surat = '$foto_surat' where id = '$_POST[id]'
    ";
